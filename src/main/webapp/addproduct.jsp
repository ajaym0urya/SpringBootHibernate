        ...
        <form action="addproduct" method="post">
            ...
            <div class="row justify-content-center">
                <div class="form-group col-3 col-offset-4 align-center">
                    ...
                    <input type="text" name="pdesp" class="form-control" required>
                </div>
            </div>
            <br>
            <div class="row justify-content-center">
                <div class="form-group col-3 col-offset-4 align-center">
                    ...
                    <select name="select" class="form-control" required>
                        ...
                        <option value="1">Mobiles, Computers</option>
                        <option value="2">Electronics & Accessories</option>
                        <option value="3">Groceries</option>
                        <option value="4">Baby Products</option>
                        <option value="5">Health & Personal Care</option>
                        <option value="6">Software</option>
                        <option value="7">Tools & Home Improvement</option>
